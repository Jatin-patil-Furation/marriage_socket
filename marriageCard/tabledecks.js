...
function Table(boot, privateTableKey) {
    ...
    this.showCards = function (args) {
        console.log("show the  card hello", args);
        console.log("cardSets", args.cardSets);
        console.log("pureRound", args.pureRound);
        console.log("maalSeen", args.maalSeen);
        ...
        if (!args.pureRound) {
            ...
            if (res && args.pureRound) {
                ...
                const checkArray = removeDuplicates(updatePlayer.handSet, updatePlayer.dirtCard);
